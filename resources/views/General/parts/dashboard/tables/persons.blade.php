...
<tr>
    <td>
        <div class="d-flex px-2">
            <div class="a-avatar mx-2" >
                <img src="{{$person["image"] ?? asset('img/small-logos/logo-spotify.svg')}}" class="img-fluid" alt="spotify">
            </div>
            <div class="my-auto">
    ...
    <td>
        <p class="text-sm font-weight-normal mb-0">{{$person["age"]}}</p>
    </td>
    <td>
        <span class="text-sm font-weight-normal">{{$person["address"]}}</span>
    </td>
    <td class="align-middle">
        <div class="d-flex">
            <span class="text-sm font-weight-normal">{{$person["role"]}}</span>
        </div>
    </td>
    <td class="align-middle">
        <div class="d-flex">
            <span class="text-sm font-weight-normal">{{$person["country"]["name"] ?? ""}}</span>
        </div>
    </td>

    <td class="align-middle">
        <a href="javascript:showModel('{{$person["id"]}}' ,  JSON.stringify({{json_encode($person)}}) );"  class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit user">
        ...
        <a href="javascript:confirmModel.show({{$person["id"]}});" style="margin-left: 10px" class="text-secondary font-weight-bold text-xs " data-bs-toggle="tooltip" data-bs-title="Remove Country">
