<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  @if(request()->route()->getName() == "persons") active @endif  " href="{{route("persons")}}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i style="font-size: 20px" class="fa-solid fa-person"></i>

                    </div>
                    <span class="nav-link-text ms-1">Persons</span>
                </a>
            </li>
            @endhasanyrole
            ...
            @hasanyrole(["admin", "super-admin"])
            <li class="nav-item">
                <a class="nav-link  @if(request()->route()->getName() == "countries") active @endif " href="{{route("countries")}}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">

                        <i style="font-size: 20px "  class="fa-solid fa-earth-europe"></i>
                    </div>
            ...
            @hasanyrole(["admin", "super-admin", "author"])
            <li class="nav-item">
                <a class="nav-link  @if(request()->route()->getName() == "articles") active @endif " href="{{route("articles")}}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
            ...
            @hasanyrole(["admin", "super-admin"])
            <li class="nav-item">
                <a class="nav-link  @if(request()->route()->getName() == "authors") active @endif " href="{{route("authors")}}">
                    <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <i style="font-size: 18px " class="fa-solid fa-feather"></i>
                    </div>
