                            ...
                            <table class="table align-items-center justify-content-center mb-0">
                                    ...
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="{{asset('img/small-logos/logo-spotify.svg')}}" class="w-80"
                                                     alt="spotify">
                                            </div>
                                            <div class="my-auto">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="{{asset('img/small-logos/logo-invision.svg')}}" class="w-80"
                                                     alt="invision">
                                            </div>
                                            <div class="my-auto">
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <div class="border px-1 py-1 text-center d-flex align-items-center border-radius-sm my-auto">
                                                <img src="{{asset('img/logos/mastercard.png')}}" class="w-90 mx-auto"
                                                     alt="mastercard">
                                            </div>
                                            <div class="ms-2">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="{{asset('img/small-logos/logo-jira.svg')}}" class="w-80"
                                                     alt="jira">
                                            </div>
                                            <div class="my-auto">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex px-2">
                                            <div class="avatar avatar-sm rounded-circle bg-gray-100 me-2 my-2">
                                                <img src="{{asset('img/small-logos/logo-slack.svg')}}" class="w-80"
                                                     alt="slack">
                                            </div>
                                            <div class="my-auto">
