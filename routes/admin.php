...
Route::group([ 'middleware'=>'auth:admin,author'],function (){
    ...
    Route::delete('/articles/{id}', [ArticleController::class , "destroy"])->name('delete.articles');
...
//    })->name('dashboard');
    ...
    Route::delete('/countries/{id}', [CountryController::class , "destroy"])->name('delete.countries');
    ...
    Route::delete('/persons/{id}', [PersonController::class , "destroy"])->name('delete.persons');
    ...
    Route::delete('/authors/{id}', [AuthorController::class , "destroy"])->name('delete.authors');
